    ...
    return (
        <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-purple-800">
            <div className="container mx-auto px-4 py-3 flex flex-wrap items-center justify-between">
                <Link
                    to={"/"}
                    className="text-2xl font-semibold text-purple-400 items-center space-x-2 flex"
                >
                    E-Commerce
                </Link>
                <nav className="flex flex-wrap items-center gap-4">
                    ...
                    {user && (
                        <Link
                            to={"/cart"}
                            className="relative group flex items-center text-gray-300 hover:text-purple-400 transition duration-300 ease-in-out"
                        >
                            <ShoppingCart
                                className="inline-block mr-2 group-hover:text-purple-400"
                                size={20}
                            />
                            <span className="hidden sm:inline">Cart</span>
                            <span className="absolute -top-3 -left-2 bg-purple-500 text-white rounded-full px-2 py-1 group-hover:bg-purple-400 transition duration-300 ease-in-out text-xs">
                                3
                            </span>
                        </Link>
                    )}
