            ...
            <div className="space-y-4 ">
                <div>
                    ...
                    <input
                        id="voucher"
                        type="text"
                        className="block w-full rounded-lg border border-gray-600 bg-gray-700 p-2.5 text-sm text-white placeholder-gray-400 focus:border-purple-500 focus:ring-purple-500"
                ...
                {isCouponApplied && coupon && (
                    <div className="mt-4">
                        ...
                        <p className="mt-2 text-sm text-shadow-gray-400">
